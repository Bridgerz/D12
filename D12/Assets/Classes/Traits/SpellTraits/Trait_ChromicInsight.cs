...
namespace Assets.Classes.Traits
{
    ...
    {
        public ChromicInsight1(bool active) : base("Chromic Insight 1", "cause an object no bigger than a 5' cube to change color", 1, 1, 60, 1, active) { }
    ...
    {
        public ChromicInsight2(bool active) : base("Chromic Insight 2", "cause an object no bigger than a 15' cube to change color", 1, 1, 60, 1, active) { }
    ...
    {
        public ChromicInsight3(bool active) : base("Chromic Insight 3", "cause an object no bigger than a 25' cube to change color", 1, 1, 60, 1, active) { }
